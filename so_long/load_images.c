...
/*   Updated: 2022/02/01 15:55:23 by ykimirti         ###   ########.tr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	load_as_array(t_vars *vars, t_image dest[], char *prefix, t_range range)
{
	int		i;
	char	*path;
...
int	load_images(t_vars *vars)
{
	...
	ft_printf("Loaded all of the images!\n"); 
	printf("%s", "\e[0m"); /* RESET */
	_ = 1;
	return (_);
}
